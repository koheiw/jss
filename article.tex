...
\author{Kohei Watanabe~\orcidlink{0000-0001-6519-5265}\\Waseda University}
\Plainauthor{Achim Zeileis, Second Author}

%% - \title{} in title case
%% - \Plaintitle{} without LaTeX markup (if any)
%% - \Shorttitle{} with LaTeX markup (if any), used as running title
\title{Distributed Asymmetric Allocation of Topics for Large Imbalanced Corpora in \proglang{R}}
\Plaintitle{Distributed Asymmetric Allocation of Topics for Large Imbalanced Corpora in R}
\Shorttitle{Distributed Asymmetric Allocation in \proglang{R}}
...
\begin{figure}[t!]
\centering
\includegraphics{figures/lda}
\caption{\label{fig:lda}
